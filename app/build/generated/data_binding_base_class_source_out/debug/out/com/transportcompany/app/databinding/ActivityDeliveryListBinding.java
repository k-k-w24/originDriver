...
public final class ActivityDeliveryListBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityDeliveryListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDeliveryListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_delivery_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDeliveryListBinding bind(@NonNull View rootView) {
